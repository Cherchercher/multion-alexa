...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output = (
            "Hi, I'm your social media manager on X.com! "
            "I can help you with your social media post and comments. Just say something like, "
            "write a new post on techworkers, and I'll take care of it for you!"
        )
...
class AmazonShoppingIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        message, done = asyncio.run(ai_assistant.ask_question(query))
...
class CancelOrStopIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Goodbye! Thank you for using Assistant X."
